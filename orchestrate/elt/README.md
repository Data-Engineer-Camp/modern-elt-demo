...
You can start writing assets in `elt/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `elt_tests` directory and you can run tests using `pytest`:
